...
public class UpsideDownIndestructibleTargetBlockEntity extends BlockEntity implements Nameable {
    public float rot;
    public float oRot;
    ...
    public UpsideDownIndestructibleTargetBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.UPSIDE_DOWN_INDESTRUCTIBLE_TARGET_BE.get(), pos, state);
    }

    public static void clientTick(Level level, BlockPos pos, BlockState state, UpsideDownIndestructibleTargetBlockEntity be) {
        be.oRot = be.rot;
    ...
    public Component getName() {
        return customName != null ? customName : Component.translatable("block.hardenedtargets.upside_down_indestructible_target");
    }
