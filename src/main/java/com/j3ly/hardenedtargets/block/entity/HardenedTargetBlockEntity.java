...
public class HardenedTargetBlockEntity extends BlockEntity implements Nameable {
    public float rot;
    public float oRot;
    ...
    public HardenedTargetBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.REINFORCED_TARGET_BE.get(), pos, state);
    }

    public static void clientTick(Level level, BlockPos pos, BlockState state, HardenedTargetBlockEntity be) {
        be.oRot = be.rot;
    ...
    public Component getName() {
        return customName != null ? customName : Component.translatable("block.hardenedtargets.reinforced_target");
    }
