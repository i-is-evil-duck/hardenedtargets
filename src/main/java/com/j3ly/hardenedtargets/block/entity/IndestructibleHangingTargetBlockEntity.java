...
public class IndestructibleHangingTargetBlockEntity extends BlockEntity implements Nameable {
    public float rot;
    public float oRot;
    ...
    public IndestructibleHangingTargetBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.INDESTRUCTIBLE_HANGING_TARGET_BE.get(), pos, state);
    }

    public static void clientTick(Level level, BlockPos pos, BlockState state, IndestructibleHangingTargetBlockEntity be) {
        be.oRot = be.rot;
    ...
    public Component getName() {
        return customName != null ? customName : Component.translatable("block.hardenedtargets.indestructible_hanging_target");
    }
