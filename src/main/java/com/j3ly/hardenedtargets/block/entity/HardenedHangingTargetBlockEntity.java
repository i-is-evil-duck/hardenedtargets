...
public class HardenedHangingTargetBlockEntity extends BlockEntity implements Nameable {
    public float rot;
    public float oRot;
    ...
    public HardenedHangingTargetBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.HARDENED_HANGING_TARGET_BE.get(), pos, state);
    }

    public static void clientTick(Level level, BlockPos pos, BlockState state, HardenedHangingTargetBlockEntity be) {
        be.oRot = be.rot;
    ...
    public Component getName() {
        return customName != null ? customName : Component.translatable("block.hardenedtargets.hardened_hanging_target");
    }
