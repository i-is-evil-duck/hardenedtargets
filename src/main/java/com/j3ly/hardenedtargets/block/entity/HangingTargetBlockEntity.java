...
public class HangingTargetBlockEntity extends BlockEntity implements Nameable {
    public float rot;
    public float oRot;
    private GameProfile owner;
    private Component customName;

    public HangingTargetBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.HANGING_TARGET_BE.get(), pos, state);
    }

    public static void clientTick(Level level, BlockPos pos, BlockState state, HangingTargetBlockEntity be) {
        be.oRot = be.rot;
    ...
    public void hit(Level level, BlockState state, BlockHitResult hitResult, boolean isUpper) {
        ...
        level.setBlock(worldPosition,
                ...
                3);
        level.scheduleTick(worldPosition, state.getBlock(), 60);
        setChanged();
    }
    ...
    public Component getName() {
        return customName != null ? customName : Component.translatable("block.hardenedtargets.hanging_target");
    }
