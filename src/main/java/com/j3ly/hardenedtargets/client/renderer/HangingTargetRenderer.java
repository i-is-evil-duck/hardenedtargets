...
public class HangingTargetRenderer implements BlockEntityRenderer<HangingTargetBlockEntity> {
    private static final ResourceLocation HANGING_TEXTURE = new ResourceLocation("hardenedtargets", "textures/entity/hanging_target.png");

    public HangingTargetRenderer(BlockEntityRendererProvider.Context context) {}
    ...
    @Override
    public void render(HangingTargetBlockEntity be, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        getModel().ifPresent(model -> {
            ...
            RenderType renderType = RenderType.entityCutout(HANGING_TEXTURE);
    ...
    @Override
    public boolean shouldRenderOffScreen(HangingTargetBlockEntity be) {
        return true;
    }
}
