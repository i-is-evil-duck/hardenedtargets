...
public class UpsideDownHardenedTargetRenderer implements BlockEntityRenderer<UpsideDownHardenedTargetBlockEntity> {
    ...
    public UpsideDownHardenedTargetRenderer(BlockEntityRendererProvider.Context context) {}
    ...
    @Override
    public void render(UpsideDownHardenedTargetBlockEntity be, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
    ...
    @Override
    public boolean shouldRenderOffScreen(UpsideDownHardenedTargetBlockEntity be) {
        return true;
    }
}
