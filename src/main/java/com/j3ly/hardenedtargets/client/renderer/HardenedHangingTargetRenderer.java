...
public class HardenedHangingTargetRenderer implements BlockEntityRenderer<HardenedHangingTargetBlockEntity> {
    private static final ResourceLocation HARDENED_HANGING_TEXTURE = new ResourceLocation("hardenedtargets", "textures/entity/reinforced_target.png");

    public HardenedHangingTargetRenderer(BlockEntityRendererProvider.Context context) {}
    ...
    @Override
    public void render(HardenedHangingTargetBlockEntity be, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        getModel().ifPresent(model -> {
            ...
            RenderType renderType = RenderType.entityCutout(HARDENED_HANGING_TEXTURE);
    ...
    @Override
    public boolean shouldRenderOffScreen(HardenedHangingTargetBlockEntity be) {
        return true;
    }
}
