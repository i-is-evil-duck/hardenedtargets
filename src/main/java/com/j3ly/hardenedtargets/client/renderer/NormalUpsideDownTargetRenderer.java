...
public class NormalUpsideDownTargetRenderer implements BlockEntityRenderer<NormalUpsideDownTargetBlockEntity> {
    private static final ResourceLocation NORMAL_UPSIDE_DOWN_TEXTURE = new ResourceLocation("hardenedtargets", "textures/entity/normal_upside_down_target.png");

    public NormalUpsideDownTargetRenderer(BlockEntityRendererProvider.Context context) {}
    ...
    @Override
    public void render(NormalUpsideDownTargetBlockEntity be, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        getModel().ifPresent(model -> {
            ...
            RenderType renderType = RenderType.entityCutout(NORMAL_UPSIDE_DOWN_TEXTURE);
    ...
    @Override
    public boolean shouldRenderOffScreen(NormalUpsideDownTargetBlockEntity be) {
        return true;
    }
}
