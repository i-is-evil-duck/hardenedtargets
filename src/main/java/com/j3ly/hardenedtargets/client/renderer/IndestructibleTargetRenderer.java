...
public class IndestructibleTargetRenderer implements BlockEntityRenderer<IndestructibleTargetBlockEntity> {
    ...
    public IndestructibleTargetRenderer(BlockEntityRendererProvider.Context context) {}
    ...
    @Override
    public void render(IndestructibleTargetBlockEntity be, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
    ...
    @Override
    public boolean shouldRenderOffScreen(IndestructibleTargetBlockEntity be) {
        return true;
    }
}
