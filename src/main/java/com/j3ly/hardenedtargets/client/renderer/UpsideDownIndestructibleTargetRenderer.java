...
public class UpsideDownIndestructibleTargetRenderer implements BlockEntityRenderer<UpsideDownIndestructibleTargetBlockEntity> {
    private static final ResourceLocation INDESTRUCTIBLE_TEXTURE = new ResourceLocation("hardenedtargets", "textures/entity/indestructible_target.png");

    public UpsideDownIndestructibleTargetRenderer(BlockEntityRendererProvider.Context context) {}
    ...
    @Override
    public void render(UpsideDownIndestructibleTargetBlockEntity be, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        getModel().ifPresent(model -> {
            ...
            RenderType renderType = RenderType.entityCutout(INDESTRUCTIBLE_TEXTURE);
    ...
    @Override
    public boolean shouldRenderOffScreen(UpsideDownIndestructibleTargetBlockEntity be) {
        return true;
    }
}
