...
public class HardenedTargetRenderer implements BlockEntityRenderer<HardenedTargetBlockEntity> {
    ...
    @Override
    public void render(HardenedTargetBlockEntity be, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
    ...
    @Override
    public boolean shouldRenderOffScreen(HardenedTargetBlockEntity be) {
        return true;
    }
}
